    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th>Pasien</th>
                <th class="transaction-column">Jumlah Transaksi</th>
                <th class="nominal-column">Total Nominal</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($report['rows'] as $item)
                <tr>
                    ...
                    <td class="transaction-column">
                        {{ number_format((int) $item['jumlah_transaksi'], 0, ',', '.') }}
                    </td>
                    <td class="nominal-column">{{ $money($item['total_nominal']) }}</td>
                </tr>
            @empty
                <tr class="empty-row">
                    <td colspan="4">Tidak ada transaksi pasien pada periode dan cabang yang dipilih.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
